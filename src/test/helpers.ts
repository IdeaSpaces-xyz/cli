...
export const MOCK_ROUTES = {
  ...
  "GET /repos/repo_test/sync/status": {
    repo_id: "repo_test",
    status: "fresh",
    is_fresh: true,
    repo_head: "abc123",
  ...
  "POST /repos/repo_test/sync/pull": {
    repo_id: "repo_test",
    diverged: false,
    old_head: "abc123",
    new_head: "def456",
    indexed_files: 2,
    removed_entries: 0,
    changed_markdown_files: ["core/about.md"],
    status: "ok",
  },
  "POST /repos/repo_test/sync/push": {
    repo_id: "repo_test",
    rejected: false,
    reason: null,
    head: "def456",
  ...
  "POST /repos/repo_test/credentials": {
    repo_id: "repo_test",
